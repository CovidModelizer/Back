...
import com.inf1.app.batch.data.SituationReelleReader;
...
public class BatchConfiguration implements WebMvcConfigurer {
    ...
    JdbcBatchItemWriter<SituationReelleDTO> writer(DataSource dataSource) {
        return new JdbcBatchItemWriterBuilder<SituationReelleDTO>()
                ...
                .sql("INSERT INTO situation_reelle (date, r0, cumul_cas_confirmes, nouveaux_cas_confirmes, " +
                        "cumul_cas_confirmes_ehpad, "
                        + "nouveaux_cas_confirmes_ehpad, cas_possibles_ehpad, cumul_gueris, nouveaux_gueris, " +
                        "cumul_deces, "
                        + "nouveaux_deces, cumul_deces_ehpad, nouveaux_deces_ehpad, reanimation, hospitalises, " +
                        "tests_realises, "
                        + "tests_positifs, nouvelles_hospitalisations, nouvelles_reanimations, " +
                        "cumul_premieres_injections, "
                        + "nouvelles_premieres_injections, stock_nombre_total_doses, stock_nombre_doses_pfizer, "
                        + "stock_nombre_doses_moderna, stock_ehpad_nombre_doses_pfizer, " +
                        "cumul_livraisons_nombre_total_doses, "
                        ...
                        + "nouvelles_livraisons_nombre_doses_moderna, total_prises_rendez_vous_semaine, " +
                        "prises_rendez_vous_semaine_rang1, "
                        + "prises_rendez_vous_semaine_rang2, sir_s, sir_i, sir_r, svir_s, svir_v, svir_i, svir_r, " +
                        "svir_nouveau_taux_vaccination) "
                        ...
                        + ":nouveauxDeces, :cumulDecesEhpad, :nouveauxDecesEhpad, :reanimation, :hospitalises, " +
                        ":testsRealises, "
                        + ":testsPositifs, :nouvellesHospitalisations, :nouvellesReanimations, " +
                        ...
                        + ":nouvellesLivraisonsNombreDosesModerna, :totalPrisesRendezVousSemaine, " +
